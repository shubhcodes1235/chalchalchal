                        ...
                        return (
                            <div key={item.href} className="relative -top-8">
                                <Link href={item.href}>
                                    <motion.div
                                        whileTap={{ scale: 0.9 }}
                                        className="w-14 h-14 rounded-full bg-night-950 dark:bg-primary/20 text-white dark:text-primary flex items-center justify-center shadow-xl border-4 border-background"
                                    >
                            ...
                            <div className="relative">
                                <Icon
                                    className={cn(
                                        ...
                                        isActive ? "text-night-950 dark:text-foreground stroke-[2.5px]" : "text-night-400 dark:text-muted-foreground"
                                    )}
                                />
                                {isActive && (
                                    <motion.div
